      ...
      <div class="title">
        <div class="icon-state-wrap">
          ...
          <div class="state-dots-wrap">
            ...
            >              <div
                class="dot"
                [ngClass]="{ active: states[currentState] === i18n.getTranslation('large-cursor') }"
              ></div>
              <div
                class="dot"
                [ngClass]="{
                  active: states[currentState] === i18n.getTranslation('reading-mask')
                }"
              ></div>
            </div>
          </div>
...
export class ScreenMaskComponent {
  ...
  currentState = 0;
  base = this.i18n.getTranslation('screen-mask');
  states = [this.base, this.i18n.getTranslation('large-cursor'), this.i18n.getTranslation('reading-mask')];
  ...
  private _runStateLogic() {
    ...
    if (this.states[this.currentState] === this.i18n.getTranslation('large-cursor')) {
    ...
    if (this.states[this.currentState] === this.i18n.getTranslation('reading-mask')) {
